...
/*
Plugin Name: Footer
Description: Footer une extension de wordpress Simple avec 2 sous menus : un pour les informations générale du plugin et un pour les settings.
Version: 1.0
Author: Yahya Naim
...
function my_admin_menu () {
    ...
    add_menu_page('Description title', 'Footer', 'manage_options','Description_page', 'Description_admin_page','dashicons-admin-home');
